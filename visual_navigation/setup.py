...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'wildos_sync_tuner = visual_navigation.wildos_sync_tuner:main',
            'objmask_sync_tuner = visual_navigation.objmask_sync_tuner:main',
            'initial_goal_mux = visual_navigation.initial_goal_mux:main',
